...
- **Study**「知识工作助手使用指南」：教用户如何使用软件各项功能
...
STUDY_ONBOARDING: dict[str, Any] = {
    ...
    "nodes": [
        {
            ...
            "detail_payload": {
                "what_is": "知识工作助手是一款双模式（Study/Work）知识图谱软件，帮助你将碎片化的知识结构化为可视化的图谱。",
    ...
    "edges": [
        ("欢迎来到知识工作助手", "如何创建与管理图谱", "related"),
        ("如何创建与管理图谱", "节点与详情卡", "related"),
        ("节点与详情卡", "延伸与扩展", "related"),
        ("延伸与扩展", "测验功能", "related"),
        ("欢迎来到知识工作助手", "对话首页", "related"),
        ("欢迎来到知识工作助手", "插件采集", "related"),
    ],
}
